    ...
    <footer className="bg-black text-gray-400">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed">
              Tempat kursus musik terbaik dengan guru profesional dan metode pengajaran modern.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2.5">
              <Link href="/#home" className="block text-sm hover:text-white transition-colors">Beranda</Link>
              <Link href="/#about" className="block text-sm hover:text-white transition-colors">Tentang</Link>
              <Link href="/#courses" className="block text-sm hover:text-white transition-colors">Kursus</Link>
              <Link href="/#contact" className="block text-sm hover:text-white transition-colors">Kontak</Link>
            </div>

            <div className="mt-6">
              <h4 className="text-white font-semibold mb-4">Partnership</h4>
              <a 
                href="https://www.rslawards.com/rockschool/" 
                target="_blank" 
          ...
          <div>
            ...
            <div className="flex gap-3 mt-4">
              ...
              <Link href="/auth/login" className="w-9 h-9 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-red-600 transition-colors">
        ...
        <div className="mt-10 pt-8 border-t border-gray-800 text-center text-sm">
          <p>&copy; {new Date().getFullYear()} Music Sphere. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
