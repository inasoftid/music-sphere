  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert(error.error || 'Failed to create mentor');
      }
    } catch (error) {
      console.error('Error creating mentor:', error);
      alert('An error occurred while creating mentor');
    } finally {
      setIsSubmitting(false);
    }
  };
          ...
          <div>
            ...
            {!photoPreview ? (
              ...
              <div className="space-y-3">
                ...
                <label className="flex items-center gap-2 px-4 py-2 bg-indigo-600 text-white rounded-lg cursor-pointer hover:bg-indigo-700 transition-colors text-sm w-fit">
                  <Upload size={16} />
